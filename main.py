# This program solves a mathematical problem by getting inputs from the user.
import numbers, calculus
from tkinter import *
...
""" def main():
    print("Please enter a number in rectangular form.")
    input1 = int(input())
    print(calculus.toPolar(input1))
    print("Please enter a number in polar form.")
    input2 = int(input())
    input3 = int(input())
    print(calculus.toRectangular(input2, input3)) """
